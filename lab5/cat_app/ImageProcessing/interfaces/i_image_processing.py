...
class IImageProcessing(ABC):
    ...
    @abstractmethod
    def _convolution(self, image: np.ndarray, kernel: np.ndarray,variant:str) -> np.ndarray:
        """
    ...
    @abstractmethod
    def _rgb_to_grayscale(self, image: np.ndarray,variant:str) -> np.ndarray:
        """
    ...
    @abstractmethod
    def _gamma_correction(self, image: np.ndarray, gamma: float,variant:str) -> np.ndarray:
        """
    ...
    @abstractmethod
    def edge_detection(self, image: np.ndarray,variant:str) -> np.ndarray:
        """
    ...
    @abstractmethod
    def corner_detection(self, image: np.ndarray,variant:str) -> np.ndarray:
        """
